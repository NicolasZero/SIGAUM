-- ########## Schema Public ########## --
-- insert genders, states, municipalities, parishes, countries, month

INSERT INTO genders OVERRIDING SYSTEM VALUE VALUES (0,'SIN ESPECIFICAR'),(1,'Mujer'),(2,'Hombre'),(3,'Otro');
SELECT pg_catalog.setval('public.genders_id_seq', 4, true);

INSERT INTO MONTH OVERRIDING SYSTEM VALUE VALUES 
(0,'SIN ESPECIFICAR'),
(1,'Enero'),
(2,'Febrero'),
(3,'Marzo'),
...
-- Cede central
INSERT INTO states OVERRIDING SYSTEM VALUE VALUES (0,'CEDE CENTRAL');
INSERT INTO municipalities OVERRIDING SYSTEM VALUE VALUES (0,0,'SIN ESPECIFICAR');
INSERT INTO parishes OVERRIDING SYSTEM VALUE VALUES (0,0,'SIN ESPECIFICAR');
...
(20, 3, 'Otros');
(21, 4, 'SIN INFORMACIÓN')

SELECT pg_catalog.setval('regions.type_activity_id_seq', 22, true);
